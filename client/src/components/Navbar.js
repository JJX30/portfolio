...
const Navbar = () => {
  ...
  const title = "<Mauricio Del Castillo />";
  return (
    <div>
      {small ? (
          ...
          <div className={styles.navbar_right}>
            <div onClick={handleClick} className={styles.navbar_hamburger}>
              ...
              <div ref={menu} className={styles.navbar_hamburger_hidden}>
                <Link href="/work" className={styles.navbar_content_hidden}>
                  <div
                ...
                <Link href="/about" className={styles.navbar_content_hidden}>
                  <div
                ...
                <Link href="/contact" className={styles.navbar_content_hidden}>
                  <div
